...
function markdownToHtml(markdown: string): string {
  // Convert markdown headings and formatting to email-safe HTML
  const html = markdown
    // H2 headings (## Title)
    .replace(
      /^## (.+)$/gm,
    ...
    <tr>
      <td align="center" style="padding: 40px 16px;">
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width: 600px; width: 100%;">
          ...
          <tr>
            <td style="padding: 24px 32px; text-align: center;">
              <p style="font-family: Arial, sans-serif; font-size: 13px; color: #8B7D6B; line-height: 1.6; margin: 0;">
                Vajda Gábor e.v. | AI Automatizálási Tanácsadó<br>
                <a href="https://www.gaborvajda.com" style="color: #C2613A; text-decoration: none;">www.gaborvajda.com</a>
              </p>
              <p style="font-family: Arial, sans-serif; font-size: 11px; color: #B0A696; margin: 12px 0 0 0;">
                Ezt az emailt azért kaptad, mert kitöltötted az AI felmérést a felmeres.gaborvajda.com oldalon.
              </p>
            </td>
          </tr>
